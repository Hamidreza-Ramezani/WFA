...
results_dir="$HOME/cortes-roofline-results/may25/para-wfa"
...
data_path7="${dataset_path}/${synthetic}-l${l7}-${distance}-32000Pairs"
results_dir="$HOME/cortes-roofline-results/may25/para-wfa"
...
#advisor -collect roofline -stacks -enable-cache-simulation -project-dir "${results_dir}/l${l6}-${distance}-6400Pairs" --app-working-dir=$HOME/WFA/bin -- $HOME/WFA/bin/align_benchmark -i ${data_path6} -a gap-affine-wfa-adaptive -g "0,3,4,1"
#
advisor -collect roofline -stacks -enable-cache-simulation -project-dir "${results_dir}/l${l7}-${distance}-32KPairs" --app-working-dir=$HOME/WFA/bin -- $HOME/WFA/bin/align_benchmark -i ${data_path7} -a gap-affine-wfa-adaptive -g "0,3,4,1"
